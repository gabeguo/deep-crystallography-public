...
do
    OUTPUT_FOLDER=/home/gabeguo/data/crystallography_paper_version/paper_results/${CRYSTAL_SYSTEM}_noXRD
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noXRD_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noXRD_visualizations
