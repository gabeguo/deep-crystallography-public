...
do
    OUTPUT_FOLDER=/data/therealgabeguo/crystallography/paper_results/${CRYSTAL_SYSTEM}_gan
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_gan_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_gan_visualizations
