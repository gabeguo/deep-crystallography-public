# Usage: CUDA_VISIBLE_DEVICES=x bash ignore_chem_ratios_noXRD.sh [Cubic (or) Trigonal]
...
do
    OUTPUT_FOLDER=/home/gabeguo/data/crystallography_paper_version/paper_results/${CRYSTAL_SYSTEM}_ignoreChemicalRatiosNoXRD
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_ignoreChemicalRatiosNoXRD_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_ignoreChemicalRatiosNoXRD_visualizations
