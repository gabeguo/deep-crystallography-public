# Usage: CUDA_VISIBLE_DEVICES=x bash one_xrd_impact.sh crystal_system
...
do
    OUTPUT_FOLDER=/home/gabeguo/data/crystallography_paper_version/paper_results/${CRYSTAL_SYSTEM}_oneXRD
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_oneXRD_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_oneXRD_visualizations
