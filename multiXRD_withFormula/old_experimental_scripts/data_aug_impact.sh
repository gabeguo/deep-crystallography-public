...
do
    OUTPUT_FOLDER=/data/therealgabeguo/crystallography/paper_results/${CRYSTAL_SYSTEM}_noDataAug
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noDataAug_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noDataAug_visualizations
