...
do
    OUTPUT_FOLDER=/home/gabeguo/data/crystallography_paper_version/paper_results/${CRYSTAL_SYSTEM}_noFormula
    MODEL_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noFormula_model.pt
    RESULTS_PATH=$OUTPUT_FOLDER/${CRYSTAL_SYSTEM}_noFormula_visualizations
