...
def main():
    ...
    parser.add_argument('--old_mp_id_to_formula', type=str, default='Cubic_formulas.json',
                        help='Input JSON file with mapping of mp_id to chemical formula.')
    parser.add_argument('--old_mp_id_to_spacegroup', type=str, default='Cubic_space_groups.json',
                        help='Input JSON file with mapping of mp_id to spacegroup numbers.')
    parser.add_argument('--new_mp_id_to_formula', type=str, default='Cubic_formulas_NO_DUPLICATES.json',
                        help='Output JSON file with mapping of mp_id to chemical formula, with duplicates removed')
    parser.add_argument('--new_mp_id_to_spacegroup', type=str, default='Cubic_space_groups_NO_DUPLICATES.json',
